 <!-- Navbar -->
 <nav class="main-header navbar navbar-expand-md" style="background-color:rgb(166, 89, 238)">
     <div class="container">
         <a href="<?= base_url() ?>" class="navbar-brand">
             <i class="fas fa-store text-white"></i>
             <span class="brand-text font-weight-light" style="color: white;"><b>AdaToko</b></span>
         </a>
             ...
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="#">AdaToko</a></li>
