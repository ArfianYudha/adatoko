                    ...
                    foreach ($kategori as $key => $v) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm"><i class="fas fa-edit" data-toggle="modal" data-target="#edit<?= $v->id_kategori ?>"></i></button>
                                <button class="btn btn-danger btn-sm"><i class="fas fa-trash" data-toggle="modal" data-target="#delete<?= $v->id_kategori ?>"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Kategori</label>
                        <input type="text" name="nama_kategori" value="<?= $v->nama_kategori ?>" class="form-control" placeholder="Kategori" required>
                    </div>
    ...
    <div class="modal fade" id="delete<?= $v->id_kategori ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('kategori/delete/' . $v->id_kategori) ?>" class="btn btn-danger">Delete</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
